<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-4">Address Information</h3>
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-4">Guardian Information</h3>
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-4">Academic Information</h3>
